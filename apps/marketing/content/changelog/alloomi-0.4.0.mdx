...
OpenLoomi now supports rich document preview capabilities across a wide range of formats:
...
- **Usage Insights**: New usage tab showing activity details and usage records
